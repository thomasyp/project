...
if __name__== '__main__':
    ...
    fuel = PowerDesityCreater('NormPowerD',powerFile='fuel.dat',volFile='volfuel.dat',\
    sideLenth=sideLen,cellFlux=cellflux,radius=r,dataType = 'f')
    graphte = PowerDesityCreater('NormPowerD',powerFile='graphte.dat',volFile='volgraphte.dat',\
